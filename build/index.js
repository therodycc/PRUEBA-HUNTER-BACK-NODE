...
require("./db/database");
const ActorsRoutes_1 = __importDefault(require("./routes/ActorsRoutes"));
...
class Server {
    ...
    routes() {
        this.app.use("/api/actors", ActorsRoutes_1.default);
        this.app.use("/api/movies", MoviesRoutes_1.default);
        this.app.use("/api/popup", PopUpRoutes_1.default);
    }
    start() {
